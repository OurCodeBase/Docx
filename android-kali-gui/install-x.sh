...

{
  ...
  wget https://raw.githubusercontent.com/OurCodeBase/Docx/main/android-kali-gui/hd-screen/vncstart
} && {
  wget https://raw.githubusercontent.com/OurCodeBase/Docx/main/android-kali-gui/hd-screen/vncstop
} && {
  mv vncst* /usr/bin
